			      ...
			      size_t count, loff_t * offset)
{
	...
	/* null check to prevent kernel panic - P120106-0629 */
	if ((NULL == pn544_dev) || (NULL == &pn544_dev->read_mutex)) {
		pr_err("pn544_dev is NULL or read_mutex is NULL");
		return -EINVAL;
	}
		       ...
		       const struct i2c_device_id *id)
{
	...
	pn544_disable_irq(pn544_dev);
	/* enable_irq_wake(client->irq); - GGSM NFC */
