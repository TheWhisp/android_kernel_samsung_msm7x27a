...
#define	TS_DRVIER_VERSION	"3.0.6"
...
// ESD Protection
#define	ZINITIX_ESD_TIMER_INTERVAL	3	//second : if 0, no use. if you have to use, 3 is recommended
...
// Use misc device : for show info & upgrade
#define	USE_TS_MISC_DEVICE	0
