 ...
 * @cell : base mfd cell
 * @irq : interrupt number to be added to each IORESOURCE_IRQ in the cell
 * @block : block id used for identification with platform data and for enable and altfunc callbacks.
 */
...
/* IC2 : Output interrupt polarity */
#define STMPE_ICR_LSB_ActiveLow		(0 << 2)
#define STMPE_ICR_LSB_ActiveHigh	(1 << 2)
/* IC1 : Output interrupt type */
#define STMPE_ICR_LSB_EDGE		(1 << 1)
#define STMPE_ICR_LSB_LEVEL		(0 << 1)
/* IC0 : Global interrupt mask bit */
