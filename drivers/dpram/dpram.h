...
#define DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS \
	(DPRAM_START_ADDRESS + 0x0004)
#define DPRAM_PDA2PHONE_FORMATTED_TAIL_ADDRESS \
	(DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS + 0x0002)
#define DPRAM_PDA2PHONE_FORMATTED_BUFFER_ADDRESS \
	(DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS + 0x0004)
#define DPRAM_PDA2PHONE_FORMATTED_SIZE 1020

#define DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS \
	(DPRAM_PDA2PHONE_FORMATTED_BUFFER_ADDRESS\
	 + DPRAM_PDA2PHONE_FORMATTED_SIZE)
#define DPRAM_PDA2PHONE_RAW_TAIL_ADDRESS \
	(DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS + 0x0002)
#define DPRAM_PDA2PHONE_RAW_BUFFER_ADDRESS \
	(DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS + 0x0004)
#define DPRAM_PDA2PHONE_RAW_SIZE 31736 /* 7160 *//*1BF0*/

#define DPRAM_PHONE2PDA_FORMATTED_HEAD_ADDRESS \
	(DPRAM_PDA2PHONE_RAW_BUFFER_ADDRESS\
	 + DPRAM_PDA2PHONE_RAW_SIZE)
#define DPRAM_PHONE2PDA_FORMATTED_TAIL_ADDRESS \
	(DPRAM_PHONE2PDA_FORMATTED_HEAD_ADDRESS + 0x0002)
#define DPRAM_PHONE2PDA_FORMATTED_BUFFER_ADDRESS \
	(DPRAM_PHONE2PDA_FORMATTED_HEAD_ADDRESS + 0x0004)
#define DPRAM_PHONE2PDA_FORMATTED_SIZE 1020	/* 0x03FC */

#define DPRAM_PHONE2PDA_RAW_HEAD_ADDRESS \
	(DPRAM_PHONE2PDA_FORMATTED_BUFFER_ADDRESS\
	 + DPRAM_PHONE2PDA_FORMATTED_SIZE)
#define DPRAM_PHONE2PDA_RAW_TAIL_ADDRESS \
	(DPRAM_PHONE2PDA_RAW_HEAD_ADDRESS + 0x0002)
#define DPRAM_PHONE2PDA_RAW_BUFFER_ADDRESS \
	(DPRAM_PHONE2PDA_RAW_HEAD_ADDRESS + 0x0004)
#define DPRAM_PHONE2PDA_RAW_SIZE 31736 /* 23544 *//* 1BF0 */

/* indicator area*/
#define DPRAM_INDICATOR_START \
	(DPRAM_START_ADDRESS + 0xFFEC)
#define DPRAM_INDICATOR_SIZE 0

#define DPRAM_PDA2PHONE_INTERRUPT_ADDRESS \
	(DPRAM_START_ADDRESS + 0xFFFC)
#define DPRAM_PHONE2PDA_INTERRUPT_ADDRESS \
	(DPRAM_START_ADDRESS + 0xFFFE)
#define DPRAM_INTERRUPT_PORT_SIZE 2
